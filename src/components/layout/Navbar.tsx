...
export default function Navbar({ collections = [] }: { collections?: NavCollection[] }) {
  ...
  return (
    <>
      {/* Outer header: always full bleed, no bg */}
            ...
            animate={
              isScrolled
                ? {
                    ...
                    boxShadow:
                      "0 8px 32px -4px rgba(47,58,51,0.14), 0 0 0 1px rgba(47,58,51,0.07)",
                    paddingLeft: 20,
                    paddingRight: 20,
                    paddingTop: 10,
                    paddingBottom: 10,
          ...
          <div className="fixed inset-0 z-[200] md:hidden" role="dialog" aria-modal="true" aria-label="Site menu">
            ...
            >
              ...
              <nav className="flex flex-col gap-1 font-medium text-neutral-darkest">
                ...
                {collections.length > 0 && (
                  <>
                    <p className="text-xs font-semibold uppercase tracking-wide text-neutral-dark pt-4 pb-2">
                      Categories
                    </p>
                    {collections.map((c) => (
                      <Link
                ...
                <Link
                  href="/pages/science"
                  className="py-3 border-b border-neutral-light/80 hover:text-primary transition-colors"
                  onClick={() => setMobileOpen(false)}
                >
                  The Science
                </Link>
